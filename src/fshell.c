      ...
      if (check_and (input) == false)
        {
          if (check_pipe (input) == false)
          ...
          else
            {
              ...
              strlcpy (copy_inputA, pipe_chain->sentence,
              ...
              if (alias_cmd == NULL)
                ...
                {
                  tmp_aliasA_cmd_copy = (char *)calloc (
                      count_for_strlcpy (alias_cmd), sizeof (char));
                  strlcpy (tmp_aliasA_cmd_copy, alias_cmd,
                           count_for_strlcpy (alias_cmd));
              ...
              char *copy_inputB = (char *)calloc (
                  count_for_strlcpy (pipe_chain->sentence), sizeof (char));
              strlcpy (copy_inputB, pipe_chain->sentence,
                       count_for_strlcpy (pipe_chain->sentence));
              ...
              if (alias_cmd == NULL)
                ...
                {
                  tmp_aliasB_cmd_copy = (char *)calloc (
                      count_for_strlcpy (alias_cmd), sizeof (char));
                  strlcpy (tmp_aliasB_cmd_copy, alias_cmd,
                           count_for_strlcpy (alias_cmd));
              ...
              if (current->sentence != NULL)
                {
                  if (check_pipe (current->sentence) == false)
                  ...
                  else
                    {
                      ...
                      char **input_arrayB
                          = (char **)calloc (array_pipe_num, sizeof (char *));
                      char *tmp_aliasA_cmd_copy = NULL,
                           *tmp_aliasB_cmd_copy = NULL;
                      char *copy_inputA = (char *)calloc (
                          count_for_strlcpy (pipe_chain->sentence),
                          sizeof (char));
                      strlcpy (copy_inputA, pipe_chain->sentence,
