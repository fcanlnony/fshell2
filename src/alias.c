...
alias_t
init_alias (alias_t alias_chain, const char *alias_name, const char *alias_command)
{
...
alias_t
upload_alias_node (alias_t alias_chain, const char *alias_name, const char *alias_command)
{
...
alias_t
remove_alias_node (alias_t alias_chain, const char *alias_name)
{
...
char *
getalias_command (const alias_t alias_chain, const char *alias_name)
{
  alias_t current = alias_chain;
  while (1)
    {
